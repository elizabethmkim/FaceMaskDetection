...
#         model = torch.load('../Config/inceptionResnetV1.pth',map_location=torch.device('cpu'))
        ...
        cv2.imwrite('output/gb.jpg', gb)
        cv2.imwrite('output/cam_gb.jpg', cam_gb)
...
#         model = torch.load('../Config/inceptionResnetV1.pth',map_location=torch.device('cpu'))
        ...
        cv2.imwrite('static/gc/gb.jpg', gb)
        cv2.imwrite('static/gc/cam_gb.jpg', cam_gb)
        print('GradCam image dispayed in same path')
        return
