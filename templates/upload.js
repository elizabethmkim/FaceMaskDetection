...
var gradcam = `I determined... drumroll please... that your face is ${className}! The next two images are my GradCAM outputs, which tells you where I looked to come to this decision. How'd I do?`
...
function choosefinal(){
    ...
    function pullFlask(id, name, original) {
        classID = id;
        className = name;
